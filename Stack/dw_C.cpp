...
int main(){
    ...
    int container_size = n*x;
    Dish* container = new Dish[container_size];
    ...
    Stack<Dish>* dirty = new ArrayStack<Dish>(container, container_size, 1, true);
    Stack<Dish>* clean = new ArrayStack<Dish>(container, container_size, -1, true);
